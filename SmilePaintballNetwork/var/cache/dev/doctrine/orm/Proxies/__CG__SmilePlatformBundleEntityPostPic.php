 ...
 */
class PostPic extends \Smile\PlatformBundle\Entity\PostPic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\PostPic' . "\0" . 'id', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\PostPic' . "\0" . 'url', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\PostPic' . "\0" . 'alt', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\PostPic' . "\0" . 'file'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PostPic $proxy) {
