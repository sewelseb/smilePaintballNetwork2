...
class Post extends \Smile\PlatformBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'user', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'team', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'upvotes', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'downvotes', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'comments', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'eventName', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'creationTime', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'picture', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'url', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'type', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'nullable', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'thumbnails', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'firstView', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'views', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'isEvent', '' . "\0" . 'Smile\\PlatformBundle\\Entity\\Post' . "\0" . 'event'];
        }
    ...
    public function setThumbnails($thumbnails)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setThumbnails', [$thumbnails]);

        return parent::setThumbnails($thumbnails);
    }
    ...
    public function getThumbnailsWithoutSlash()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getThumbnailsWithoutSlash', []);

        return parent::getThumbnailsWithoutSlash();
    }
    ...
    public function getFirstView()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFirstView', []);

        return parent::getFirstView();
    }
    ...
    public function setFirstView($firstView)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFirstView', [$firstView]);

        return parent::setFirstView($firstView);
    }
    ...
    public function isIsEvent()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isIsEvent', []);

        return parent::isIsEvent();
    }
    ...
    public function setIsEvent($isEvent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsEvent', [$isEvent]);

        return parent::setIsEvent($isEvent);
    }
