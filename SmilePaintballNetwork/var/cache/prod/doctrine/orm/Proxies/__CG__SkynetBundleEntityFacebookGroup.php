...
namespace Proxies\__CG__\SkynetBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class FacebookGroup extends \SkynetBundle\Entity\FacebookGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SkynetBundle\\Entity\\FacebookGroup' . "\0" . 'id', '' . "\0" . 'SkynetBundle\\Entity\\FacebookGroup' . "\0" . 'facebookId', '' . "\0" . 'SkynetBundle\\Entity\\FacebookGroup' . "\0" . 'groupName', '' . "\0" . 'SkynetBundle\\Entity\\FacebookGroup' . "\0" . 'timezone', '' . "\0" . 'SkynetBundle\\Entity\\FacebookGroup' . "\0" . 'accountForPosting', '' . "\0" . 'SkynetBundle\\Entity\\FacebookGroup' . "\0" . 'language'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacebookGroup $proxy) {
    ...
    public function setAccountForPosting($accountForPosting)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAccountForPosting', [$accountForPosting]);

        return parent::setAccountForPosting($accountForPosting);
    }
    ...
    public function getAccountForPosting()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAccountForPosting', []);

        return parent::getAccountForPosting();
    }
